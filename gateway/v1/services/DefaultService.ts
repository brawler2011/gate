...
export class DefaultService {
    ...
    public publishProblem({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/tester/problems/{id}/publish',
            path: {
                'id': id,
            },
        });
    ...
    public getPublishedPackage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/tester/problems/{id}/package/{version}',
            path: {
                'id': id,
                'version': version,
            },
    ...
    public initProblemWorkshop({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/tester/problems/{problemId}/workshop/init',
            path: {
                'problemId': problemId,
            },
        });
    ...
    public listWorkshopFiles({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/tester/problems/{problemId}/workshop/files',
            path: {
                'problemId': problemId,
            },
            query: {
    ...
    public getWorkshopFile({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/tester/problems/{problemId}/workshop/files/{path}',
            path: {
                'problemId': problemId,
                'path': path,
            },
    ...
    public commitWorkshopChanges({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/tester/problems/{problemId}/workshop/commit',
            path: {
                'problemId': problemId,
            },
            body: requestBody,
    ...
    public getWorkshopStatus({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/tester/problems/{problemId}/workshop/status',
            path: {
                'problemId': problemId,
            },
        });
    ...
    public getWorkshopHistory({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/tester/problems/{problemId}/workshop/history',
            path: {
                'problemId': problemId,
            },
            query: {
    ...
    public compileProblemComponent({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/tester/problems/{problemId}/workshop/components/{componentType}/compile',
            path: {
                'problemId': problemId,
    ...
    public generateTests({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/tester/problems/{problemId}/workshop/tests/generate',
            path: {
                'problemId': problemId,
            },
            body: requestBody,
    ...
    public validateAllTests({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/tester/problems/{problemId}/workshop/tests/validate',
            path: {
                'problemId': problemId,
            },
        });
    ...
    public testSolution({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/tester/problems/{problemId}/workshop/solutions/test',
            path: {
                'problemId': problemId,
            },
            body: requestBody,
    ...
    public listOrganizationMembers({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/tester/organizations/{id}/members',
            path: {
                'id': id,
            },
            query: {
